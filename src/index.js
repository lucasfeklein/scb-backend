...
wss.on("connection", async (ws, request) => {
  ...
  ws.on("message", async (message) => {
    ...
    const prompt = `You are a helpful chatbot who loves to help people. You're designed to answer only based on the Content provided, outputted in Markdown format. If it's not about the content say that you're not able to answer it.
